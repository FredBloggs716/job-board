    ...
    <header className="sticky top-0 z-30 bg-surface-deep/95 backdrop-blur border-b border-surface-border px-4 sm:px-6 py-3 flex flex-wrap items-center justify-between gap-3">
      <div className="flex items-center gap-4 min-w-0">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-brand bg-brand flex items-center justify-center flex-shrink-0 shadow-card">
            <svg className="w-4.5 h-4.5 text-white" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.25} strokeLinecap="round" strokeLinejoin="round">
